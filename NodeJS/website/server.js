...
const accountSid = 'AC8643eefcd239cea67363dacb0e5d9798'
const authToken = '504831e5ef2c32875774b2ee6cc66f84';
...
app.post('/rsvp', function(req, res){
  ...
  collection.updateOne({"_id" : ObjectID(req.body.form_response.hidden.rsvpid)}, {$push: { RSVP : req.body.form_response.answers[1].number}})
...
app.post('/invite', function(req, res){
  ...
  numbersToMessage.forEach(function(number){
    var message = client.messages.create({
      body: 'Please register for the party at: https://developerplatform.typeform.com/to/dV8B3V?rsvpid=5c722e518c848a24544511e4',
      from: '+17025087860',
      to: number
    })
  ...
  //
  // twiml.message('Please register for the party at: https://developerplatform.typeform.com/to/dV8B3V?rsvpid=5c722e518c848a24544511e4');
  //
